...
`bryanunitek/UniSaaS.UniCORE.OpenSSL` is the **OpenSSL** family member: SaaS-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source TLS/SSL toolkit — cryptographic foundation for all UniCORE secure communication.

**Deployment shape:** This is the **SaaS-shape** member of the family. It tracks the same upstream codebase as [`UniCORE.OpenSSL`](https://github.com/bryanunitek/UniCORE.OpenSSL) (on-prem shape) but carries SaaS-specific configuration, multi-tenant isolation patterns, and cloud-native deployment artefacts.

---

## Upstream

- **Upstream project:** https://github.com/openssl/openssl
...
UniCORE.OpenSSL is published as a **four-repo family**:

- `bryanunitek/UniCORE.OpenSSL` — public on-prem-deployment-shape gift surface
- `bryanunitek/UniSaaS.UniCORE.OpenSSL` — public SaaS-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniCORE.OpenSSL-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.OpenSSL-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniSaaS.UniCORE.OpenSSL/discussions)
